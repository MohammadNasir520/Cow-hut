...
const updateCow = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedCow = yield cow_service_1.CowService.updateCow(id, sellerId, updatedDAta);
    res.status(200).json({
        success: true,
        statusCode: 200,
...
const deleteSingleCow = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    const { id } = req.params;
    const sellerId = (_b = req.user) === null || _b === void 0 ? void 0 : _b._id;
    const deleteSingleCow = yield cow_service_1.CowService.deleteSingleCow(id, sellerId);
    res.status(200).json({
        success: true,
        statusCode: 200,
